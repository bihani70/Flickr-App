...
#import "FCViewController3.h"
#import "FC.h"
#import "JTViewController.h"
#import "LazyLoad.h"


@interface FCViewController3 ()

@property(assign,nonatomic)BOOL ascending;
@property(strong,nonatomic)UIRefreshControl *refreshControl;
@end

@implementation FCViewController3

@synthesize ascending,refreshControl;
...
- (void)viewDidLoad
{
    ...
    url = [NSURL URLWithString:@"http://api.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=4c1fa4212b6f2cccc4cadcca4759c97c&extras=owner_name%2Cdate_upload%2C+date_taken%2Cdescription%2Ctags%2Cmachine_tags%2Cgeo%2Curl_t&format=json&nojsoncallback=1"];
